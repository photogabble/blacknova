...
$smarty->assign("character_name", $playerinfo['character_name']);
$smarty->assign("player_credits", number_format($playerinfo['credits']), 0, $local_number_dec_point, $local_number_thousands_sep);
...
$smarty->assign("igb_consolidate_allowed", $igb_consolidate_allowed);
$smarty->assign("l_igb_logout", $l_igb_logout);
$smarty->display("$templateset/igb_login.tpl");
