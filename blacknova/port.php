...
//  echo "    form.total_cost.value = '$l_no_credits';\n";
  echo "    form.total_cost.value = (form.total_cost.value - $playerinfo[credits]) +' additional credits required';\n";
  echo "  }\n";
...
return $dropdownvar;
  ...
  echo "    <TD ALIGN=RIGHT>$l_totalcost: <INPUT TYPE=TEXT style=\"text-align:right\" NAME=total_cost SIZE=42 VALUE=0 $onfocus $onblur $onchange $onclick></td>\n";
  echo "  </TR>\n";
  echo " </TABLE>\n";
  echo "</FORM>\n";
