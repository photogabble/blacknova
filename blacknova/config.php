...
//ammount of rating gained from combat
$rating_combat_factor		= .8;

//Percantage of planet's value a ship must be worth to be able to capture it.
// 0=disable
$min_value_capture 			= 0; 
$defence_degrade_rate		= 0.05;
$energy_per_fighter			= 0.10;

//Max amount a player can place as bounty - good idea to make it the same as $IGB_svalue.
// 0=disable
$bounty_maxvalue			= 0.15;

// ratio of players networth before attacking results in a bounty.
// 0=disable
$bounty_ratio				= 0.75; 

// Minimum number of turns a target must have had before attacking them may not get you a bounty.
// 0=disable
$bounty_minturns			= 500;
...
Example:
//Which Disables the Planet Watcher Module.
$Enable_PlanetWatcher		= false;  

//Which Enables the Planet Watcher Module.
$Enable_PlanetWatcher		= true;   
*/
