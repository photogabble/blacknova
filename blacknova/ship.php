...
$res2 = $db->Execute("SELECT ship_name, character_name, sector FROM $dbtables[players] WHERE player_id=$player_id");
...
else
{
	...
	echo "<a href=scan.php?player_id=$player_id>$l_planet_scn_link</a><br>";
	echo "<a href=attack.php?player_id=$player_id>$l_planet_att_link</a><br>";
