...
echo '\n<form name="bntform" action="igb_consolidate.php" method="post" accept-charset="utf-8" onsubmit="document.bntform.submit_button.disabled=true;">';
echo "\n<table width=\"600\" height=\"350\" border=\"0\">";
echo "\n  <tr>";
...
echo "\n<tr valign=top>" .
     "\n<td>" .
     "\n<br><font color=\"#00FF00\">$l_igb_conspl :<br><br>" .
...
echo "\n</select></font></td><td valign=top align=right>" .
     "\n<br><input class=term name=submit_button type=submit name=planetc value=\"  $l_igb_consolidate  \">" .
     "\n</td></tr>";
