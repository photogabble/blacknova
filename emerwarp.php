...
if ($shipinfo['dev_emerwarp'] > 0)
{
    ...
    $debug_query = $db->Execute ("UPDATE {$db->prefix}ships SET sector_id=$dest_sector, " .
                                 "dev_emerwarp=dev_emerwarp-1 WHERE ship_id=$shipinfo[ship_id]");
...
// Easter egg comment - Loc is down with the ladies, ya know what I mean?
$smarty->assign("title", $title);
$smarty->assign("ewd_output", $ewd_output);
$smarty->assign("l_global_mmenu", $l_global_mmenu);
$smarty->display("$templateset/emerwarp.tpl");
