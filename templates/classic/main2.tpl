...
<table class="center" width="80%" cellpadding="0" cellspacing="1" border="0">
...
<div class="center smalltext highlightcolor" style="white-space:nowrap;"><img src="templates/{$templateset}/images/lcorner.png" alt=""><strong class="headingcolor">Your Avatar</strong><img src="templates/{$templateset}/images/rcorner.png" alt=""></div>
...
<div class="center smalltext highlightcolor" style="white-space:nowrap;"><img src="templates/{$templateset}/images/lcorner.png" alt=""><strong class="headingcolor">{$l_commands}</strong><img src="templates/{$templateset}/images/rcorner.png" alt=""></div>

<div class="mnu" style="white-space: nowrap;">
  <ul class="nostyle">
    <li><a class="mnu" href="planet_report.php">{$l_planets}</a></li>
