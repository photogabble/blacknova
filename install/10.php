...
// File: install/0.php
    ...
    if ($safe_mode)
    {
        echo "The machine you are running this script on appears to have \"safe_mode\" enabled. This is a good thing.<br>";
        echo "It shows that your webhosting company cares about security, and has taken steps to ensure that your site ";
        echo "is safe.<br>";
        echo "However, it means that the automatic portions of this script won't function properly.\n<br>";
    ...
    if ($game_installed && $swordfish != $adminpass)
    {
        ...
        echo "<form action=\"install.php\" method=\"post\" accept-charset=\"utf-8\"><input type=password name=swordfish value=\"\">&nbsp;";
    ...
    if ($showit == 1)     // Preparing values for the form
    {
        ...
        echo "<form action=\"install.php\" method=\"post\" accept-charset=\"utf-8\"><table>";
