...
if (!$pos)
{
    // Redirect to install if game not installed yet.
    dynamic_loader ($db, "install_redirect.php");
    install_redirect($ADODB_SESSION_DRIVER);

    global $db;
    $db = connectdb($ADODB_SESSION_DB, $ADODB_SESSION_DRIVER, $ADODB_SESSION_USER, $ADODB_SESSION_PWD, $ADODB_SESSION_CONNECT, $dbport, $raw_prefix);
