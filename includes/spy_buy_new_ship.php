...
function spy_buy_new_ship($db,$old_ship_id)
{
    ...
    $res2 = $db->Execute("DELETE FROM {$db->prefix}spies WHERE ship_id = '$old_ship_id' ");  // Including player's own spies!
}
?>
