...
//
// File: incudes/spy_ship_destroyed.php
...
function spy_ship_destroyed($db,$ship_id, $attacker_player_id = 0)
{
    ...
    $debug_query = $db->Execute("DELETE FROM {$db->prefix}spies WHERE ship_id = $ship_id "); 
    db_op_result($db,$debug_query,__LINE__,__FILE__);
}
?>
